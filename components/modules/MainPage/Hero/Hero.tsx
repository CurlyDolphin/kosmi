...
const Hero = () => {
  ...
  const slides = [
    {
      id: 1,
      title: `${translations[lang].main_page.tShirt} «Samurai» ${translations[lang].main_page.black}`,
      image: img1,
    },
    {
      id: 2,
      title: `${translations[lang].main_page.tShirt} «Samurai» ${translations[lang].main_page.orange}`,
      image: img2,
    },
    {
      id: 3,
      title: `${translations[lang].main_page.tShirt} «Samurai» ${translations[lang].main_page.violet}`,
      image: img3,
    },
  ]
